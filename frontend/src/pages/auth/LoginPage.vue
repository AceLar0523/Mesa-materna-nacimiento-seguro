<template>
  <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-orange-50 via-white to-pink-50">
    <!-- Parallax Background -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
      <!-- Blob 1 -->
      <div
        class="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-gradient-to-br from-[#F97316]/30 to-[#991a73]/15 blur-3xl"
        :style="{ transform: `translateY(${parallaxOffset * 0.5}px)` }"
      ></div>
      <!-- Blob 2 -->
      <div
        class="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-gradient-to-br from-[#991a73]/30 to-[#F97316]/15 blur-3xl"
        :style="{ transform: `translateY(${-parallaxOffset * 0.3}px)` }"
      ></div>
      <!-- Blob 3 -->
      <div
        class="absolute top-1/2 left-1/2 h-64 w-64 rounded-full bg-gradient-to-br from-pink-300/20 to-orange-200/10 blur-3xl"
    ...
    <div class="relative z-10 flex min-h-screen items-center justify-center px-4 py-8">
      <div class="w-full max-w-md">
        ...
        <!-- Form Card -->
        <div class="backdrop-blur-xl rounded-3xl border border-white/50 bg-white/90 p-8 shadow-2xl text-gray-900">
          <!-- Tabs -->
          ...
          <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="space-y-5">
            <div>
              ...
              <input
                ...
                class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder-gray-400 transition-all focus:border-[#F97316] focus:outline-none focus:ring-2 focus:ring-[#F97316]/20"
                required
              />
            </div>
          ...
          <div class="flex gap-3 justify-center">
            <button
              class="rounded-xl border-2 border-gray-200 py-3 px-6 font-semibold text-gray-700 transition-all hover:border-[#F97316] hover:bg-orange-50"
            >
...
// Parallax effect
const handleScroll = () => {
  parallaxOffset.value = window.scrollY || document.documentElement.scrollTop;
};
